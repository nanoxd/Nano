...
/// A protocol for anything that provides a set `NSLayoutAnchor`s
/// found in `UIView`/`NSView` and `NSLayoutGuide`/`UILayoutGuide`.
...
public extension Anchorable {
    ...
    @discardableResult
    func set(size sizeAnchor: SizeAnchor, relation: LayoutRelation = .equal, isActive: Bool = true) -> NSLayoutConstraint {
...
extension Anchorable {
    ...
    /// - Returns: An `[NSLayoutConstraint]` between the current `Anchorable` and another `Anchorable`.
    @discardableResult
    func pin(toAnchorable anchorable: Anchorable, edges: [EdgeAnchor] = EdgeAnchor.allSides, relation: LayoutRelation = .equal, isActive: Bool = true) -> [NSLayoutConstraint] {
    ...
    /// - Returns: An `NSLayoutConstraint` between the current `Anchorable` and another `Anchorable`.
    @discardableResult
    func pin(edge: EdgeAnchor, toEdge: EdgeAnchor, ofAnchorable anchorable: Anchorable, relation: LayoutRelation = .equal, constant: CGFloat = 0.0, priority: LayoutPriority = .required, isActive: Bool = true) -> NSLayoutConstraint {
    ...
    /// - Returns: An `NSLayoutConstraint` between the current `Anchorable` and another `Anchorable`.
    @discardableResult
    func set(relativeSize sizeAnchor: SizeAnchor, toSizeAnchor: SizeAnchor, ofAnchorable anchorable: Anchorable, multiplier: CGFloat, constant: CGFloat, relation: LayoutRelation = .equal, isActive: Bool = true) -> NSLayoutConstraint {
